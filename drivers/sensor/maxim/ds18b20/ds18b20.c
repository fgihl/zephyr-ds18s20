...
static bool is_ds18s20(const struct device *dev)
{
	const struct ds18b20_config *cfg = dev->config;

	return cfg->chip == type_ds18s20;
}

static inline void ds18b20_temperature_from_raw(
...
#define DS18B20_TYPE type_ds18b20
...
#define DS18S20_TYPE type_ds18s20
